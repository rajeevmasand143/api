concerns_events = [
            'injuries', 'property damage', 'lawsuits', 'settlements', 'claims', 'contaminate',
            'attribution', 'crash', 'disaster', 'theft', 'breakthrough', 'carcinogenic',
            'liability', 'breach', 'emerging', 'toxic', 'wrongful death', 'breach of implied warranty',
            'negligence', 'failure to warn', 'new technology', 'new health research',
            'new legislation', 'international legislation', 'new research', 'new understanding',
            'new idea', 'surprising finding', 'changing trend', 'novel discovery',
            'new knowledge', 'new regulation', 'catastrophe', 'financial loss'
        ]
        
emerging_risks = [
            'kratom', 'delta-8', 'tianeptine', 'THC-O', 'Tris (2-carboxyethyl) phosphine',
            'diisononyl phthalate', 'DINP', 'diisodecyl phthalate', 'DIDP', 'Terephthalic acid',
            '3D Printing', 'Alternative Energy', 'Artificial Intelligence', 'Autonomous Vehicles',
            'Avian Flu', 'Biodiversity Loss', 'Blockchain', 'Cannabis', 'Civil Unrest',
            'Class Action Lawsuits', 'Climate Change', 'Climate Change Government Activity',
            'Climate Change Risk Insurance', 'Climate Change Sea Level Flooding',
            'Climate Change Transition Risks', 'Climate Change Wildfires', 'Counterfeit Products',
            'Data Breach Security', 'Driver Vehicle Issues', 'Drones', 'E-Cigarettes vaping',
            'Electric Vehicles', 'Epigenetics', 'Food-Related Issues', 'Genetic Engineering',
            'Hydraulic Fracturing', 'Internet of Things', 'Lithium Batteries', 'MaaS Ridesharing',
            'Mass Timber Construction', 'Mobility as a Service', 'Nanotechnology', 'Obesity Epidemic',
            'Oil Gas Well Decommissioning', 'Opioids', 'Outer Space', 'Pandemic', 'Ransomware',
            'Sharing Economy', 'Social Engineering', 'Social Media', 'Sports-related Injuries',
            'Substances and Materials', 'Supply Chains', 'Telemedicine', 'Virtual Currencies',
            'Water-Related Issues', 'Novel Psychoactive Substances', 'Robotics', 'Psychedelics',
            'Litigation', 'PFAS', 'Plastics and Microplastics', 'Government Activity',
            'Social Inflation', 'Human Trafficking', 'Chemical substances', 'Hazardous materials'
        ]


misc_topics = [
            'home ownership', 'residential property', 'personal auto', 'homeowner',
            'fleet', 'Construction Industry', 'Contractors'
        ]
...
def get_concerns_keywords():
    """Return list of concern event keywords for text matching."""
    return concerns_events

def get_emerging_risks_keywords():
    """Return list of emerging risk keywords for text matching."""
    return emerging_risks

def get_misc_topics_keywords():
    """Return list of misc topic keywords for text matching."""
    return misc_topics

def get_naics_codes():
    """Return list of NAICS code dictionaries."""
    return naics_data

def find_naics_by_code(code: str):
    """Find NAICS description by code."""
    for item in naics_data:
        if item['code'] == code:
            return item['description']
    return None

def find_naics_by_description(description: str):
    """Find NAICS code by partial description match."""
    description_lower = description.lower()
    for item in naics_data:
        if description_lower in item['description'].lower():
            return item['code']
    return None